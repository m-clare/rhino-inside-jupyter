...
# -*- coding: utf-8 -*-
#
# rhino_inside_jupyter documentation build configuration file
#
...
project = 'rhino_inside_jupyter'
copyright = '2024, Maryanne Wachter'
...
_version_py = os.path.join(repo, 'rhino_inside_jupyter', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'rhino_inside_jupyterdoc'
...
latex_documents = [
    (master_doc, 'rhino_inside_jupyter.tex', 'rhino_inside_jupyter Documentation',
     'Maryanne Wachter', 'manual'),
]
...
man_pages = [
    ...
    'rhino_inside_jupyter Documentation',
     [author], 1)
]
